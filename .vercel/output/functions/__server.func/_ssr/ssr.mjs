...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-l4jlRkVv.mjs");
...
var manifest = { "38985a903a511b239d9da1bf3ec1a5c7efb4e3554c47f509b957b43aea388318": {
	functionName: "completeExploration_createServerFn_handler",
	importer: () => import("./chat-ogLJycKT.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-B2Gd42Vd.mjs").then((n) => n.t),
